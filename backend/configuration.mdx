---
title: "Configure MongoDB Connection and Environment"
sidebarTitle: "Configuration"
description: "Configure the Ferreandina backend via a .env file. Covers MONGODB_URI, MONGODB_DB_NAME, POJO codec setup, and CORS configuration."
---
