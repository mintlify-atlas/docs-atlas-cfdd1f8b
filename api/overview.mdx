---
title: "Ferreandina NoSQL REST API Overview and Conventions"
sidebarTitle: "Overview"
description: "Ferreandina REST API on port 7070 under /api. Covers base URL, no-auth policy, JSON envelope, HTTP method table, and links to all seven resource routes."
---
