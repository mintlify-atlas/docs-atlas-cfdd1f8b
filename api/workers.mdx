---
title: "Workers API – Manage Ferreandina Store Employees"
sidebarTitle: "Workers"
description: "CRUD endpoints for store worker records. Workers have a speciality, salary, and are embedded in branch documents. Base path: /api/workers."
---
