---
title: "Categories API: Organize Products by Type"
sidebarTitle: "Categories"
description: "CRUD endpoints for product categories. Categories group hardware products and can be filtered by ID. Base path: /api/categories."
---
